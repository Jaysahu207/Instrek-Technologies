...
import cloud from "../../assets/services/ist.jpg";
...
const CloudSolutions = () => {
  ...
  const features = [
    ...
    {
      title: "Hybrid Cloud",
      description: "Public and private cloud integration",
      icon: "🔄",
    },
    {
    ...
    {
      title: "Scalability",
      description: "Flexible resources that grow with you",
      icon: "📈",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
            ...
            >
              <div className="mb-8">
                ...
                <p className="text-xl text-gray-600">
                  Transform your business with scalable, secure cloud computing
                  solutions.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-md mb-8">
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    "Expert cloud support & management",
                  ].map((item, i) => (
        ...
        >
          ...
          <p className="text-xl mb-6">
            Contact us for a free consultation about your cloud computing needs.
          </p>
          <button
